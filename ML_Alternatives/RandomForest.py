...
def processData():
    ...
    unprocessed = pd.read_csv("C:/Users/schar/Documents/PoliSciResearch/vars/comboTraining-train.tsv")
    #unprocessed = pd.read_csv("C:/Users/schar/Documents/PoliSciResearch/vars/comboTraining.tsv")
...
def test(clf, valsToNums):
    #The testing portion
    test = pd.read_csv("C:/Users/schar/Documents/PoliSciResearch/vars/comboTraining-dev.tsv")
