...
def preprocess(phrase):
    ...
    #phrase = [spell(w) for w in phrase]
...
def process_tsv(fileName):
    ...
    with open(fileName) as f:
        ...
        for line in f:
            ...
            doc = Document(count, category, preprocess(word_tokenize(phrase)))
...
def test(k, weightMethod, rel_method):
    ...
    trainDocuments = vectorizeCorpus(documents, freqs, "tf")

    testDocuments = process_tsv("C:/Users/schar/Documents/PoliSciResearch/vars/purposeCodeTraining-dev.tsv")
    testDocuments = vectorizeCorpus(testDocuments, freqs, "tf")
