...
class AlgorithmAnalyzer:
    ...
    def getScore(self, storeIncorrect):
        ...
        #f = spider.SpiderAlgorithm() # sub in different algorithms for usage
        f = firework.FireworkAlgorithm()
        correct = 0
        total = 0
        incorrectPC = []
        incorrectLabelings = []
...
a = AlgorithmAnalyzer("purposecode_labeled_first1100.csv")
print(a.getScore("firework_errors1100_03_23_19.csv"))
